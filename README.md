...
- **Railway**（推荐，支持 Volume 持久化）  
  - **小白一步一步教程**：见 [Railway部署一步一步.md](Railway部署一步一步.md)（从注册到上线的完整步骤）。  
  - 简要说明：见 [DEPLOY_RAILWAY.md](DEPLOY_RAILWAY.md)。
- **Render**：见 [DEPLOY_RENDER.md](DEPLOY_RENDER.md)。
